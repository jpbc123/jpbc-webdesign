...
import { categoriesFor, type PortfolioItem } from "@/data/portfolio";

/** Filterable grid; clicking a card expands its case details. */
export default function WorkGrid({ projects }: { projects: PortfolioItem[] }) {
